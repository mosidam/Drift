...
assert.match(odooTemplates, /data-model="man"/);
assert.match(odooTemplates, /data-model="woman"/);
...
assert.match(tryOnSource, /\/drift_coach\/static\/tryon\/models\/drift-model-man\.glb/);
assert.match(tryOnSource, /\/drift_coach\/static\/tryon\/models\/drift-model-woman\.glb/);
assert.match(tryOnSource, /\/drift_coach\/static\/tryon\/models\/drift-sauna-hat\.glb/);
...
assert.match(tryOnSource, /buildSaunaWardrobe/);
assert.match(tryOnSource, /data-color/);
assert.match(tryOnSource, /data-model/);
...
assert.match(pwaSource, /function ProtocolSessionModal/);
assert.match(pwaSource, /function protocolToRitual/);
assert.match(pwaSource, /Start guided session/);
...
assert.doesNotMatch(pwaSource, /Backend routes|Sync demo data|Offline coach mode|offline demo|chat-first|local MVP|authorization code|service keys/);
